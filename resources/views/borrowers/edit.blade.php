        ...
        <div class="col-md-12">
            ...
            <div class="card ">
                 ...
                 <label for="first_name" class="col-sm-2 col-form-label">First Name</label> 
                  <div class="col-sm-7" >
                   <div class="form-group">
                     <input id="first_name" name="first_name" placeholder="First Name" value="{{ $borrower->first_name}}" type="text" pattern="[a-zA-Z]+" class="form-control" required>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body ">
                ...
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="middle_name" name="middle_name" value="{{ $borrower->middle_name}}" placeholder="Middle Name" pattern="[a-zA-Z]+" type="text" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="last_name" class="col-sm-2 col-form-label">Last Name</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="last_name" name="last_name" value="{{ $borrower->last_name}}" placeholder="Last Name" type="text" pattern="[a-zA-Z]+" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="date_of_birth" class="col-sm-2 col-form-label">Date of Birth</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="date_of_birth" name="date_of_birth" value="{{ $borrower->date_of_birth}}" placeholder="2021-01-01" type="date" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row col-sm-12">
             <label for="phone1" class="col-sm-2 col-form-label">Phone 1</label> 
                <div class="col-sm-2" >
                  <div class="form-group">
                  <input id="phone1" name="phone1" value="{{ $borrower->phone1}}" placeholder="777 7777" type="tel" minlength="7" maxlength="7" class="form-control" required>
                </div>
              </div>
              ...
              <label for="phone2" class="col-sm-1 col-form-label">Phone 2</label> 
                <div class="col-sm-2" >
                  <div class="form-group">
                  <input id="phone2" name="phone2" value="{{ $borrower->phone2}}" placeholder="777 7777" type="tel" minlength="7" maxlength="7" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="address" class="col-sm-2 col-form-label">Address</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                    <input id="address" name="address" value="{{ $borrower->address}}" placeholder="Address" type="text" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="email" class="col-sm-2 col-form-label">Email</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="email" name="email" value="{{ $borrower->email}}" placeholder="loans@pmo.gov.gm" type="email" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="employment_date" class="col-sm-2 col-form-label">Employment Date</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="employment_date" name="employment_date" value="{{ $borrower->employment_date}}" placeholder="2021-01-01" type="date" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
