          ...
          <div class="card-body ">
            <div class="row">
             <label for="date_of_birth" class="col-sm-2 col-form-label">Date of Birth</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="date_of_birth" name="date_of_birth" value="{{ $borrower->date_of_birth}}" placeholder="2021-01-01" type="date" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body ">
            <div class="row">
             <label for="employment_date" class="col-sm-2 col-form-label">Employment Date</label> 
                <div class="col-sm-7" >
                  <div class="form-group">
                  <input id="employment_date" name="employment_date" value="{{ $borrower->employment_date}}" placeholder="2021-01-01" type="date" class="form-control">
                </div>
              </div>
            </div>
          </div>
